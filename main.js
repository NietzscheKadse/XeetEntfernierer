...
var delete_options = {
    ...
    "old_tweets": false, // MIGHT NOT WORK AS OF MAY 2025
...
var random_resource = "FptdvukWVyqC_Iez4vnrdQ"; // Updated resource ID because X changed this in May 2025
...
async function fetch_tweets(cursor, retry = 0) {
    ...
    console.log(final_cursor)

    var variable = "";
    var feature = "";
    var field_toggles = `&fieldToggles=%7B%22withArticlePlainText%22%3Afalse%7D`
    if (delete_options["old_tweets"] == false) {
	// Variable & Feature Parameters got changed in May 2025. We have to include a lot more of them now.
